...
import pytest
from source_outbrain.source import OutbrainStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(OutbrainStream, "path", "v0/example_endpoint")
    mocker.patch.object(OutbrainStream, "primary_key", "test_primary_key")
    mocker.patch.object(OutbrainStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = OutbrainStream()
